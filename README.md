...
This scheme is inspired by [jekyll-rtd-theme](https://github.com/rundocs/jekyll-rtd-theme) acting as a [remote-theme](https://www.siteleaf.com/blog/remote-themes/) on [our project pages](https://eq19.github.io/base) that runs using the algorithm of [DNA Recombination](https://eq19.github.io/#next-release).
